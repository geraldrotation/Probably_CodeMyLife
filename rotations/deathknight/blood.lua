...
--------------------------------------------------Defensive-------------------------------------------- 
    ...
    -- Dancing Rune Weapon
    { "49028",{"DancingRuneWeapon.novaHealing(0)"}},
    -- Conversion
    { "119975",{"Conversion.novaHealing(0)"}},
    -- Vampiric Blood
    { "55233",{"VampiricBlood.novaHealing(0)"}},
    -- Icebound Fortitude
    { "48792",{"IceboundFortitude.novaHealing(0)"}},
    -- Rune Tap
    { "48982",{"RuneTap.novaHealing(0)"}},
    -- Empower Rune Weapon
    { "47568",{"EmpowerRuneWeapon.novaHealing(0)"}},
...
-------------------------------------Interrupts--------------------------------------
    ...
    -- Death and Decay
    {"43265",{"player.runes(unholy) > 1","43265.automouse(DeathAndDecay)"},"ground"},
    
    -- Blood Tap
    {"45529",{"player.buff(114851).count >= 5","@CML.CanTap()"}},
    -- Outbreak
    {"77575",{"!target.debuff(55095)"}},
    -- Blood Boil
    {"48721",{"target.debuff(55095)","target.debuff(55095).duration < 4"}},
