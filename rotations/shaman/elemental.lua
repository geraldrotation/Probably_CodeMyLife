...
--------------------------------------------------Defensive-------------------------------------------- 
    ...
    -- lava_beam
    {"421",{"player.aoe != 1","!player.moving","player.buff(114050)",}},
    ...
    -- lava_beam
    {"114074",{"player.aoe != 1","!player.moving","player.buff(114050)"}},
	-- lava_burst,if=dot.flame_shock.remains>cast_time&(buff.ascendance.up|cooldown_react)
	{"51505",{"player.aoe = 1","!player.moving","player.spell(51505).shock"}},
    {"51505",{"player.aoe = 2","!player.moving","!player.buff(114050)","player.spell(51505).shock"}},    
	...
	{"117014",{"player.aoe != 3","talent(18)","!player.moving"}},		
    {"117014",{"player.aoe != 3","talent(18)","player.moving","player.buff(79206)"}},       
    ...
    {"421",{"player.aoe != 1","!player.moving","player.mana > 10"}},
    -- Elemental Blast if moving and Spiritwalker	
    {"117014",{"player.aoe = 1","player.moving","player.buff(79206)"}}, 
    -- lightning_bolt
    {"403",{"player.aoe = 1"}},
}, 
--------------------------------------------------Out of Combat-------------------------------------------- 
