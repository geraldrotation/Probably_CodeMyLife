...
if _Spec == 1 then PQIprefix = "PQI_CodeMyLifeArms_" Coolprefix = "PQI_CodeMyLifeCooldownsArms_" end
if _Spec == 2 then PQIprefix = "PQI_CodeMyLifeFury_" Coolprefix = "PQI_CodeMyLifeCooldownsFury_" end
if _Spec == 3 then PQIprefix = "PQI_CodeMyLifeProtection_" Coolprefix = "PQI_CodeMyLifeCooldownsProt_" end
...
if _Spec == 1 and CML_Cooldowns_Config == nil then
	Coolprefix = "PQI_CodeMyLifeCooldownsArms_"
	...
	CML_Cooldowns_Config = {
		...
		abilities = {
			...
			{ 	name	= "Bladestorm",
				tooltip	= PlayerHex.."Toggle Automatic |cffFFFFFFBladestorm.",
				enable	= true,
				widget = { type = 'select',
					values = {"|cff0DFF00Active","|cffFFE100On CD","|cffD90000Disable"},
					value = 2,
			...
			{ 	name	= "Bloodbath",
				tooltip	= PlayerHex.."Toggle Automatic |cffFFFFFFBloodbath.",
				enable	= true,
				widget = { type = 'select',
					values = {"|cff0DFF00Active","|cffFFE100On CD","|cffD90000Disable"},
					value = 2,
			...
			{ 	name	= "Dragon Roar",
				tooltip	= PlayerHex.."Toggle Automatic |cffFFFFFFDragon Roar.",
				enable	= true,
				widget = { type = 'select',
					values = {"|cff0DFF00Active","|cffFFE100On CD","|cffD90000Disable"},
					value = 2,
			...
			{ 	name	= "Skull Banner",
				tooltip	= PlayerHex.."Toggle Automatic |cffFFFFFFSkull Banner.",
				enable	= true,
				widget = { type = 'select',
					values = {"|cff0DFF00Active","|cffFFE100On CD","|cffD90000Disable"},
					value = 2,
			...
			{ 	name	= "Shockwave",
				tooltip	= PlayerHex.."Toggle Automatic |cffFFFFFFShockwave.",
				enable	= true,
				widget = { type = 'select',
					values = {"|cff0DFF00Active","|cffFFE100On CD","|cffD90000Disable"},
					value = 2,
...
if _Spec == 1 and CML_Arms_config == nil then
	...
	CML_Arms_config = {
		...
		abilities = {
			...
			{ 	name	= "Rallying Cry",
				tooltip	= "|cffFFFFFFHealth value "..PlayerHex.."to cast |cffFFFFFFRallying Cry "..PlayerHex.."on me.",
				enable	= true,
				widget	= { type = "numBox",
					value	= 15,
					width 	= 70,
...
if _Spec == 2 and CML_Cooldowns_Config == nil then
	Coolprefix = "PQI_CodeMyLifeCooldownsFury_"
